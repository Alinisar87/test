...
const html = `<!doctype html><html><head><style>
  * { margin:0; box-sizing:border-box; }
  body { width:1200px; height:630px; background:#111318; color:#F7F7F5;
  ...
  <svg class="curve" viewBox="0 0 640 320">
    <defs><linearGradient id="g" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0%" stop-color="#2AD17E" stop-opacity=".25"/>
    ...
    <path d="M 0 300 C 140 280, 240 150, 360 100 C 460 60, 560 48, 640 44" fill="none" stroke="#2AD17E" stroke-width="5" stroke-linecap="round"/>
    <line x1="420" y1="80" x2="420" y2="320" stroke="#2AD17E" stroke-opacity=".5" stroke-width="2" stroke-dasharray="6 7"/>
    <circle cx="420" cy="80" r="8" fill="#111318" stroke="#2AD17E" stroke-width="5"/>
  </svg>
</body></html>`;
