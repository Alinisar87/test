...
const html = `<!doctype html><html><head><style>
  * { margin:0; box-sizing:border-box; }
  ...
  .kicker { font-family:'Courier New', monospace; font-weight:bold; letter-spacing:.2em;
            text-transform:uppercase; color:#127246; font-size:22px; }
  ...
  <svg class="curve" viewBox="0 0 640 320">
    ...
    <line x1="420" y1="80" x2="420" y2="320" stroke="#127246" stroke-opacity=".55" stroke-width="2" stroke-dasharray="6 7"/>
    <circle cx="420" cy="80" r="8" fill="#F7F7F5" stroke="#127246" stroke-width="5"/>
  </svg>
</body></html>`;
