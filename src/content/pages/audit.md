...
deliverables:
  ...
  items:
    - title: 'Your marginal ROAS curve'
      body: 'Your last 90 days of ad spend and revenue, plotted as a curve — not averages. You see exactly how return decays as spend scales.'
    - title: 'The ceiling number'
      body: 'The specific monthly spend level where your next dollar stops making money. One number, defensible, from your own data.'
    - title: 'Profit-first P&L bridge'
      body: 'Platform ROAS reconciled to actual contribution margin — fees, shipping, returns, COGS included. Finance-grade, built by a chartered-accountant-led team.'
    - title: 'The waste map'
      body: 'Which campaigns and ad sets are already spending past their ceiling today, and what cutting them recovers immediately.'
    - title: 'The move-the-ceiling plan'
      body: 'Prioritized fixes — offer, funnel, creative, account structure — with a projected new ceiling for each, so scaling stops killing profitability.'
guarantee:
...
howItWorks:
  ...
  steps:
    ...
    - title: '5 days of analysis'
      body: 'We build your curve, the P&L bridge, and the waste map from your actual data. No juniors, no templates.'
    - title: 'Walkthrough call'
      body: 'We walk you through every number and the plan. You leave knowing your ceiling and what moves it — whether or not we ever work together again.'
faq:
